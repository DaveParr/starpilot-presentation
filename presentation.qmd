...
-   This will help me understand the level of knowledge in the room and
...
-   Generate personal suggestions of useful packages/tools for your
...
::: {.r-vstack}
![](images/typer.svg){.fragment height=100}
![](images/langchain.png){.fragment height=100}
![](images/chroma.svg){.fragment height=100}
![](images/github.png){.fragment height=100}
:::
...
-   Langchain company backed viedos
...
-   *heavily* OOP
-   Reading the sourcecode is still nessecary
    -   `kwargs` are often silently ignored, or undocumented
...
-   All the code I've shown today and all the code I didn't show is all
    Open Source licensed, so dig in
-   fork it and build a new feature
